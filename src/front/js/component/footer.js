      ...
      <div className="container">
        <div className="row justify-content-start mt-4">
          <div className="col-md-4">
            ...
            <p>
              Tech-Jobs Latin America is a remote job board for tech
              professionals in the region. We want to assist companies in
              finding the best talent and professionals in finding the best job
          ...
          <div className="col-md-3 mt-4">
            ...
            <div className="d-flex gap-3 social-media-icons">
              <a href="#">
